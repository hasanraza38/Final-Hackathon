...
const LoginModal = ({ onClose, onLogin, onSwitchToSignup, fromSignup = false }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      // The API will set cookies automatically
      // No need to manually store tokens

      // Check if the user is an admin and redirect to admin panel
      ...
      // Call the onLogin function passed from parent component with user data
